...
The character selects who is affected by Distracting Behavior and can choose to have this talent not affect NPC allies. It may be that [they] explain [their] tactics to the NPCs beforehand, or that they know [them] well enough to be used to [their] antics.
...
When affected by Distracting Behavior, NPCs suffer two threat results when making checks targeting the character's allies, instead of one threat result.
