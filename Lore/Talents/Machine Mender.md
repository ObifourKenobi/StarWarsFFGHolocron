...
When this character makes a Mechanics check to help a character heal wounds, the target heals one additional wound per rank of Machine Mender. (Typically, only droids can be healed with Mechanics check.)
