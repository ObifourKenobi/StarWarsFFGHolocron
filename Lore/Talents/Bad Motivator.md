...
Once per session when taking the Bad Motivator action, the character may choose a trigger or circumstance under which the device will fail, rather than it failing immediately. The device functions normally until that circumstance occurs.
