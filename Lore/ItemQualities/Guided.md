...
## Rule Effect (Summary)
Requires three advantages to activate. If the attack misses, may make a check at the end of the round with X ability dice and a difficulty calculated by comparing Silhouette 0 to the target's Silhouette. If successful, the weapon hits the target.
