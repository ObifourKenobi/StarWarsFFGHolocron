...
The heavy shatter rifle is another variant of the shatter weaponry created by the Verpine. More information about the weapon available on the Wookieepedia article.VERPINE HEAVY SHATTER RIFLE[1][2][]SHATTER GUNS[3][]While a character wields a shatter gun, any combat checks they make that generates two threat results or a despair result damages the weapon by one step.[4]
