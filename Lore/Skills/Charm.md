...
- Most cases where seduction of another is attempted (unless it is not willful).
Careers with Charm as a class skill
- Colonist
- Diplomat
- Mystic
Specializations with Charm as a class skill
- Advisor
- Ambassador
- Charmer
- Interrogator
...
- Scoundrel
- Sleeper Agent
Universal Specializations with Charm as a class skill
